...
| #   | Feature                                      | Status | Aufwand | Begründung |
|-----|----------------------------------------------|--------|---------|------------|
...
| A77 | Erste simulierte Saison                      | 🟡     | M       | alle Fahrerbewegungen (inkl. Altersrücktritte) sofort beim Saisonstart auslösen – Mechanik existiert, braucht korrekten Trigger |
| A81 | Werksfahrer vs. Privateer-System *(Post-Release)* | 🔴 | L  | Typ-Feld W/P/G in SEASON_DATA, Eintrittswkeit Privateers, era-basiertes Sitzlimit, ersetzt Grid-Füller |

## Zusammenfassung

- **S** (Stunden):      1 – A29
- **M** (halber Tag):   8 – A3, A5, A10, A16, A20, A22, A26, A74, A77
- **L** (1–2 Tage):     9 – A4, A11, A12, A31, A42, A47, A63, A67, A81 *(A81 Post-Release)*
