...
// DEBUG
const prost88 = finalPace['1988']?.['alain-prost'];
const berger88 = finalPace['1988']?.['gerhard-berger'];
console.log('DEBUG Prost 1988 consistency:', prost88?.consistency);
console.log('DEBUG Berger 1988 consistency:', berger88?.consistency);
console.log('DEBUG seasonStats Prost 1988:', Object.keys(require('./tests/elo_ratings.json')['alain-prost'] || {}));
