...
const LIVE_COMMENTARY = {
    ...
    pit: {
        e50: [
            ...
            '🔧 Runde {lap}: Boxenhalt {driver} – aktuell P{pos}, gleich geht die Jagd weiter.',
            ...
            '🔧 Runde {lap}: {driver} macht Station an der Box – aktuell P{pos}.',
        ...
        e62: [
            ...
            '🔧 Runde {lap}: {driver} unterbricht die Fahrt – Boxenstopp, aktuell P{pos}.',
        ...
        e76: [
            ...
            '🔧 Runde {lap}: Reifenwechsel für {driver} – aktuell P{pos}.',
    ...
    overtake: {
        e50: [
            ...
            '⚡ Runde {lap}: {driver} lässt {victim} hinter sich – nun P{pos}.',
            ...
            '⚡ Runde {lap}: {victim} muss {driver} ziehen lassen – Positionswechsel, P{pos}.',
            ...
            '⚡ Runde {lap}: Vorbei! {driver} übernimmt die Position von {victim} – P{pos}.',
        ...
        e62: [
            ...
            '⚡ Runde {lap}: Positionswechsel: {driver} nun vor {victim}, P{pos}.',
            ...
            '⚡ Runde {lap}: {driver} kämpft sich an {victim} vorbei – P{pos} für ihn.',
            ...
            '⚡ Runde {lap}: Da war die Lücke! {driver} überholt {victim} und liegt auf P{pos}.',
        ...
        e76: [
            ...
            '⚡ Runde {lap}: {driver} übernimmt P{pos} – {victim} hat das Nachsehen.',
    ...
    dnf_mechanical: {
        e50: [
            ...
            '❌ Runde {lap}: {reason}! {driver} muss den Kampf aufgeben – von P{pos} aus dem Rennen.',
            ...
            '❌ Runde {lap}: Technisches K.o. für {driver} – auf P{pos} liegend ist Schluss.',
        ...
        e62: [
            ...
            '❌ Runde {lap}: Defekt bei {driver} – aus P{pos} heraus ist Schluss.',
        ...
        e76: [
            ...
            '❌ Runde {lap}: Bitter! {reason} stoppt {driver} auf P{pos}.',
            ...
            '❌ Runde {lap}: {driver} raus! Von P{pos} direkt ins Aus – Technik-K.o.',
    ...
    dnf_accident: {
        e50: [
            ...
            '❌ Runde {lap}: {reason} auf P{pos} – {driver} ist aus dem Rennen.',
            ...
            '❌ Runde {lap}: Aus auf P{pos}: {driver} ist von der Bahn.',
        ...
        e62: [
            ...
            '❌ Runde {lap}: {reason} auf P{pos} – bitteres Ende für {driver}.',
            ...
            '❌ Runde {lap}: {driver} ist von der Bahn – aus P{pos} heraus endet sein Rennen.',
        ...
        e76: [
            ...
            '❌ Runde {lap}: {driver} auf P{pos} – dann {reason}, dann Stillstand.',
            ...
            '❌ Runde {lap}: Aus auf P{pos}! {driver} scheidet nach Unfall aus.',
    ...
    finish: {
        ...
        e76: [
            ...
            '🏁 P1 für {driver}! Ein Triumph, der sich gewaschen hat.',
